...
public class PrimitiveMesh
{
    ...
    public void PopulateMesh(Mesh mesh)
    {
        ...
        Debug.Log("Vertices List " + verticesList.Count);
        Debug.Log("normalList List " + normalList.Count);
        Debug.Log("UVList List " + UVList.Count);
        Debug.Log("triangle List " + indicesList.Count);
